...
const ListingForm = (props) => {
    ...
    const onSubmit = e => {
        ...
        setLoading(true);
        axios.post(`http://victor.20.84.39.184.nip.io/api/api/listings/search`, { sale_type, price, bedrooms, home_type, bathrooms, sqft, days_listed, has_photos, open_house, keywords }, config)
        .then(res => {
            setLoading(false);
